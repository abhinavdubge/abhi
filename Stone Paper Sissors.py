...
button1 = tkinter.Button(root, text="Stone", command=lambda: on_button_click("Stone"), width=10)
button1.grid(row=1, column=0, padx=10, pady=10)

button2 = tkinter.Button(root, text="Paper", command=lambda: on_button_click("Paper"), width=10)
button2.grid(row=1, column=1, padx=10, pady=10)

button3 = tkinter.Button(root, text="Scissor", command=lambda: on_button_click("Scissor"), width=10)
